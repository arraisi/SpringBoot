...
VALUES (1001, '{"address":{"kota":"Bandung"}}', 'John Travolta', 'john@mail.com', '$2a$10$mtEAmwAl1SSg/cfuavxME.3wBqlsTSIv.jjdmq73k8TlHmPBTRCDi',
        true, '{}', null, null, 'system', '2021-10-04 09:42:29', 'system', '2021-10-04 09:42:29');
INSERT INTO person (id, map_data, name, email, password, active, attachment_list_data, creator, editor,
                          created_by, created, updated_by, updated)
VALUES (1002, '{"address":{"kota":"Jakarta"}}', 'Will Smith', 'will@mail.com', '$2a$10$MKtR6IhurqMaLZW4IaWdtugcqjAElDpnXcSkmG.cpHhYA2o1dOyGu', true,
...
INSERT INTO person (id, map_data, name, email, password, active, attachment_list_data, creator, editor,
                          created_by, created, updated_by, updated)
VALUES (1004, '{"address":{"kota":"Bogor"}}', 'Arnold Schwarzenegger', 'arnold@mail.com',
